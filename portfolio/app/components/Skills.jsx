...
import { RiNextjsFill, 
  ...
  RiJavascriptFill, 
  RiNodejsFill, 
  RiTailwindCssFill  } from "react-icons/ri";
import { SiMongodb,
  SiExpress
 } from "react-icons/si";

 import { FaJava, FaPython, FaHtml5, FaCss3  } from "react-icons/fa";
  ...
  return (
    <section id="skills" ref={container} className = "w-screen h-screen flex items-center justify-center">
      <div className = "container mx-auto">
        <h2 className = "heading-2 text-[32px] text-center gradient-text mb-12 skills-title">
          Skills
        </h2>
